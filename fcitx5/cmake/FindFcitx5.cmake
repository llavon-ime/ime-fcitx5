...
find_package(Fcitx5Core QUIET CONFIG)
if(TARGET Fcitx5::Core)
    set(FCITX5_CORE_FOUND TRUE)
    set(FCITX5_CORE_LINK_LIBRARIES Fcitx5::Core)
    if(APPLE AND Fcitx5Core_DIR)
        get_filename_component(_fcitx5_config_prefix "${Fcitx5Core_DIR}/../../.." ABSOLUTE)
        foreach(_component IN ITEMS Core Config Utils)
            if(TARGET Fcitx5::${_component})
                set_property(TARGET Fcitx5::${_component} PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                    "${_fcitx5_config_prefix}/include/Fcitx5/${_component}")
            endif()
        endforeach()
    endif()
else()
...
if(FCITX5_CORE_FOUND AND TARGET PkgConfig::FCITX5_CORE)
